...
func BenchmarkDigest(b *testing.B) {
	x, _ := new(big.Int).SetString("3d937c035c878245caf64531a5756109c53068da139362728feb561405371cb", 16)
	for i := 0; i < b.N; i++ {
		Digest(x, x)
	}
}
...
func TestFastDigest(t *testing.T) {
	var tests = [...]struct {
		input1, input2, want string
	}{
		{
...
func BenchmarkFastDigest(b *testing.B) {
	x, _ := new(big.Int).SetString("3d937c035c878245caf64531a5756109c53068da139362728feb561405371cb", 16)
	for i := 0; i < b.N; i++ {
		FastDigest(x, x)
	}
